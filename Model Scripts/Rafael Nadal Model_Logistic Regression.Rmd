...
df_matches %>% 
  ...
  theme_few()
  #Cuando llega al match con muchos partidos y con alto win rate hay mas chances de una victoria
...
df_matches %>% 
  ...
  labs(x = "Ranking Nadal",
       y = "Ranking Rival") + 
  theme_few()#Hay mayores posibilidades de derrota si el rival forma parte del top 10
...
df_matches %>% 
  ...
  labs(x = "Surface") + 
  theme_few()#Clay es sin dudas las superficie de mayor performance
...
df_matches %>% 
  ...
  scale_fill_brewer(palette = "Set1") + 
  labs(x = "Best Of") + 
  theme_few()#A 5 sets parece rendir mejor Nadal
...
df_matches %>% 
  ...
  theme(axis.text.x = element_text(angle = 45,
                                   size = 6,
                                   vjust = 1,
                                   hjust = 1)) #En las primeras rondas el % de victorias en mayor
...
df_matches %>% 
  ...
  theme_few()#hay correlacion entre estas dos variables.
...
df_matches %>% 
  ...
  theme_few()#Entre estas no tanto
...
df_matches %>% 
  ...
  labs(x = "Partidos Nadal Últimos 3 Meses",
       y = "Partidos Nadal Último Mes") + 
  theme_few()#Entre estas algo, menos que para 3 y 6
```
